(() => {
    ...
    function scaleResult() {
        if (document.querySelector(".values-slide__item")) {
            let items = document.querySelectorAll(".values-slide__item");
            items.forEach((item => {
                let value = item.querySelector(".values-slide__value").innerText;
                let bar = item.querySelector(".values-slide__line span");
